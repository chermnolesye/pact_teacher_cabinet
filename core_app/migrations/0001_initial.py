# Generated by Django 5.1.2 on 2025-04-04 13:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tagtextabbrev', models.TextField()),
                ('tagcolor', models.CharField(max_length=7)),
                ('idtagparent', models.ForeignKey(blank=True, db_column='idtagparent', null=True, on_delete=django.db.models.deletion.CASCADE, to='core_app.errortag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iderrorlevel', models.ForeignKey(blank=True, db_column='iderrorlevel', null=True, on_delete=django.db.models.deletion.CASCADE, to='core_app.errorlevel')),
                ('iderrortag', models.ForeignKey(db_column='iderrortag', on_delete=django.db.models.deletion.CASCADE, to='core_app.errortag')),
                ('idreason', models.ForeignKey(blank=True, db_column='idreason', null=True, on_delete=django.db.models.deletion.CASCADE, to='core_app.reason')),
            ],
            options={
                'db_table': 'tblerror',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idayear', models.ForeignKey(db_column='idayear', on_delete=django.db.models.deletion.CASCADE, to='core_app.academicyear')),
            ],
            options={
                'db_table': 'tblgroup',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idrights', models.ForeignKey(db_column='idrights', default=1, on_delete=django.db.models.deletion.CASCADE, to='core_app.rights')),
            ],
            options={
                'db_table': 'tbluser',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idgroup', models.ForeignKey(db_column='idgroup', on_delete=django.db.models.deletion.CASCADE, to='core_app.group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idemotion', models.ForeignKey(blank=True, db_column='idemotion', null=True, on_delete=django.db.models.deletion.CASCADE, to='core_app.emotion')),
                ('idstudent', models.ForeignKey(db_column='idstudent', on_delete=django.db.models.deletion.CASCADE, to='core_app.student')),
                ...
                ('idtexttype', models.ForeignKey(blank=True, db_column='idtexttype', null=True, on_delete=django.db.models.deletion.CASCADE, to='core_app.texttype')),
                ('idwriteplace', models.ForeignKey(blank=True, db_column='idwriteplace', null=True, on_delete=django.db.models.deletion.CASCADE, to='core_app.writeplace')),
                ('idwritetool', models.ForeignKey(blank=True, db_column='idwritetool', null=True, on_delete=django.db.models.deletion.CASCADE, to='core_app.writetool')),
            ],
            options={
                'db_table': 'tbltext',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idtext', models.ForeignKey(db_column='idtext', on_delete=django.db.models.deletion.CASCADE, to='core_app.text')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idpostag', models.ForeignKey(blank=True, db_column='idpostag', null=True, on_delete=django.db.models.deletion.CASCADE, to='core_app.postag')),
                ('idsentence', models.ForeignKey(db_column='idsentence', on_delete=django.db.models.deletion.CASCADE, related_name='tokens', to='core_app.sentence')),
            ],
            options={
                'db_table': 'tbltoken',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iderror', models.ForeignKey(db_column='iderror', on_delete=django.db.models.deletion.CASCADE, to='core_app.error')),
                ('idtoken', models.ForeignKey(db_column='idtoken', on_delete=django.db.models.deletion.CASCADE, to='core_app.token')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='token',
            index=models.Index(fields=['idsentence'], name='tbltoken_idsente_7ce8ae_idx'),
        ),
        migrations.AddIndex(
            model_name='token',
            index=models.Index(fields=['idpostag'], name='tbltoken_idposta_83a99f_idx'),
        ),
    ]
